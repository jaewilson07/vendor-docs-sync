...
excerpt: "Configure Outlier Filters in a multi-line chart to hide lines with points above, below, or outside a specified value range."
---

## Intro

In Analyzer, you can set "Outlier Filters" on a multi-line line chart. This allows you to filter out any lines with points above, below, or in between the value or values you set. If any point on a line does not pass the filter, *that entire line is filtered out*.
...
* **Show When Points Above**. Filters your line chart to show only those lines with any values *above* the value you specify.
...
1. Select **Outlier Filtering** in **Chart Properties**.
