...
excerpt: "Implement the Scorecard V2 app to rank group members against metrics, configure groups, filters, and Beast Mode calculations, and manage configuration access."
---
...
The Column dropdown box for this modal is populated from any column in your dataset that is number, as well as any numeric Beastmodes that you have created on the dataset. Beastmodes are used here for any complicated calculations you may need to run on your data to create a metric. If you need help with creating Beast Modes, read [Create a Beast Mode Calculation](/s/article/360043429913).
