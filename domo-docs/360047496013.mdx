...
excerpt: "Use the Workbench 4 Plugin Manager to view registered plugins, add DLL-based plugins, and remove installed plugins."
---
...
file name to show the plugins within it. These are shown by type and name. For example, in the following screenshot, the user has clicked the DLL file *DomoDataProviders.dll* to show the plugins contained within it. All of these plugins are of the "Transport Method" type.
...
1. Click
   **Plugin Manager** in the **More** tab at the top of the Workbench window.
