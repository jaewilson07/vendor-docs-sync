---
title: "XY Line Chart"
excerpt: "Build an XY Line chart that uses X-Y coordinate pairs to plot trendlines, with optional series, median, and upper or lower range lines."
---
...
In the Analyzer, you choose the columns containing the data for your XY graph. For more information about choosing data columns, see [Applying DataSet Columns to Your Chart](/s/article/360043428713 "Applying DataSet Columns to Your Chart").
...
<Frame><img alt="xy_line_spreadsheet_example.png" src="/images/kb/ka05w00000123lt-00N5w00000Ri7BU-0EM5w000005vP2w.png"/></Frame>
## Customizing XY Line graphs

You can customize the appearance of an Outliers graph by editing its **Chart Properties**. For information about all chart properties, see [Chart Properties](/s/topic/0TO5w000000ZaodGAC "Chart Properties").