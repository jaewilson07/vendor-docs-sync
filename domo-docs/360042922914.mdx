...
excerpt: "Access standard Domo support resources on self-serve domains including the Knowledge Base, Community Forum, and Live Chat."
---
...
* **Knowledge Base**. The Knowledge Base (the tool you are using now) contains thousands of articles about the Domo product and its features, tools, plug-ins/add-ons, and more.
* **Community Forum**. The Community Forum is the place for you to ask questions and learn from other Domo users. View discussion boards and popular posts, and share your thoughts and ideas with those who might be working on similar projects.
...
<AccordionGroup>
<Accordion title="What is a Domo subscription?">
...
<Accordion title="Does Domo offer different support levels and services for each subscription level?">
...
<Accordion title="If I am an existing customer or an existing Free Trial user, what changes?">
