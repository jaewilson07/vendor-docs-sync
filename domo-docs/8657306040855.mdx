...
To create the credentials you need the Domo Client ID and Domo Client Secret. Learn how to get your [Domo Client ID and Secret](/s/article/000005240#create-api-clients).
