...
excerpt: "Use the AWS Data Exchange for Burbio Connector to import subscribed Burbio datasets from your AWS S3 bucket into a Domo DataSet."
---
...
3. Add a new user, setting options as follows:
    ...
    3. Click **Next: Tags** button to add tags. Adding tags is optional.
    4. In the **Review** pane, click **Create User**.
