...
excerpt: "Create a Workbench 4 DataSet Job that reads QuickBooks data by choosing a report type and configuring fiscal year and date options."
---
...
7. Click
   **Next**.
8. In the
   **Data Source** menu, select **QuickBooks**.
9. In the
...
14. Click
    **Authorize Company File** in the Buttons toolbar at the top of the Workbench window.
