...
<span>Enter a name for this Domo account.</span>
...
<span>Select desired marketplace</span>
...
<span>Fulfillment Inbound Shipment - Inbound Shipment Items</span>
...
<span>Fulfillment Inbound Shipment - List Inbound Shipments</span>
...
<span>Fulfillment Inventory - List Inventory Supply</span>

              </td>
              <td colspan="1" rowspan="1">

<span>
  Returns a list of inventory summaries that have had changes after the date
  specified.
</span>
...
<span>Fulfillment Outbound Shipment - Fulfillment Orders</span>
...
<span>Orders - List Order Items Upsert</span>
...
<span>Orders - List Orders - Upsert</span>
...
<span>Products - Competitive Prices By SKU</span>
...
<span>Products - Get Catalog Item by ASIN</span>

              </td>
              <td colspan="1" rowspan="1">

<span>
  Returns detailed catalog item information, including classifications, for the
  specified ASINs.
</span>
...
<span>Products - List Matching Products</span>
...
<span>Products - My Price for SKU</span>
...
<span>Products - Product Categories for SKU</span>

              </td>
              <td colspan="1" rowspan="1">

<span>
  Returns the parent product categories that a product belongs to, based on
  SellerSKU.
</span>
...
<span>Report Detail Filter</span>
...
<span>Select the desired report detail filter.</span>
...
<span>CSV Report Quote Character</span>
...
<span>
  Select the status you want to retrieve data for. You can select up to 10
  statuses.
</span>
...
<span>SKU Selection Method</span>
...
<span>Select Specific Start Date</span>
...
<span>Select the first date in your date range.</span>
...
<span>Select Specific End Date</span>
...
<span>Select the second date in your date range.</span>
...
<span>Days Back to Start From</span>
...
<span>Continue on Invalid SKU Error</span>
...
<span>A comma-delimited list of words to search the Amazon catalog for.</span>
...
<span>
  Specify a daily window of activity for 15-minute, 30-minute, and hour
  intervals
</span>
...
<span>Limit the schedule to run on specific days and months</span>
