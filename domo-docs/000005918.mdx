...
*   [Domo AI Pro Pricing](https://www.domo.com/consumption-terms/ai-model-pricing)
...
**Documents: File & Agent Knowledge Storage**

*   Files stored in the Documents feature will consume credits based on GB stored by Day. 
*   Agent Knowledge stored in the Documents feature will consume credits based on GB stored by Day. If a Subscriber enables Agent Knowledge, additional credits will be consumed for Agent Knowledge storage based on GB stored by Day.

**Documents: Agent Knowledge Processing**

Processing files into Agent Knowledge will consume credits based on file type.

**Documents: Agent Knowledge Query**

Queries issued against Agent Knowledge will consume credits based on each query.
