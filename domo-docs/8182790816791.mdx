...
You need Domo client credentials (client ID and client secret) and Couchbase credentials (host name, database name, username and password, and bucket). Learn how to get your [Domo Client ID and Secret](/s/article/000005240#create-api-clients).
</Accordion>
