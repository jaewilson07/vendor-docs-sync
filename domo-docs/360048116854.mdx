...
excerpt: "October 2015 release notes covering Publication group search, DataSet export to Excel or CSV, and on-demand user license management."
---
...
If you have feedback, please send it from within Domo (<i className="legacy-icon-megaphone sm" aria-hidden="true" /> **Feedback**). Or send an email to [product.feedback@domo.com](mailto:product.feedback@domo.com "product.feedback@domo.com").
