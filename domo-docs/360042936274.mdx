...
excerpt: "April 2017 release notes covering Buzz messaging improvements, Hybrid SSO for mixing direct and SSO sign-in, and App Deploy upgrades."
---
...
* get answers in the Domo Community at
  [community-forums.domo.com <i className="icon-arrow-square-out sm" aria-hidden="true" />](https://community-forums.domo.com/main "https://community-forums.domo.com/main")
