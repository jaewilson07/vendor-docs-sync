...
excerpt: "Install and use the Domo Google Sheets add-on to download DataSets to Google Sheets, edit the data, and refresh to the latest version from Domo."
---
...
4. Enter your Domo instance (if my instance is
   [customer.domo.com](http://customer.domo.com), then my instance is customer) and click **Sign In**.
...
1. Use the
**Search & filter** options to locate the DataSet you want to download.
...
3. (Optional) Click
**Preview dataset** to see the owner and last updated date.
