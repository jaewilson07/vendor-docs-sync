...
excerpt: "Use the webhook-based Infusionsoft REST Hook Connector to automatically pull Infusionsoft sales and marketing data into Domo as new data arrives."
---
...
<Accordion title="What's the difference between this connector and the Infusionsoft connector?">
...
<Accordion title="How do I know my Infusionsoft credentials are secure?">
...
<Accordion title="When I click Connect, why am I getting automatically validated without needing to enter credentials?">
