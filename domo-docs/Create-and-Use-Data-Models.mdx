...
<Note>**Note:** A Data Model created from a Snowflake semantic view opens in **read-only mode**. Its tables, relationships, and metrics are synced from Snowflake, so they can't be edited in the Data Model Editor. See [About Snowflake Semantic Views](/s/article/About-Snowflake-Semantic-Views) for details.</Note>
