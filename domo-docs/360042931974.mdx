...
excerpt: "Use Domo's Dropbox File Connector to retrieve CSV, XLS, and XLSX files from a Dropbox account into a Domo DataSet."
---
...
<table border="1" cellpadding="1" cellspacing="1" data-aura-rendered-by="33:195;a"><thead><tr><th colspan="1" rowspan="1"><p> Menu </p></th><th colspan="1" rowspan="1"><p> Description </p></th></tr></thead><tbody><tr><td colspan="1" rowspan="1"> File Type </td><td colspan="1" rowspan="1"> Select the file type for the file you want to import. In the standard version of the connector, only CSV, XLS, and XLSX files can be imported. If you want to import other file types such as JSON, XML, and ZIP files, use the <a href="/s/article/360043436553" target="_blank" title="Dropbox File Advanced Connector"> Dropbox File Advanced </a> connector. </td></tr><tr><td colspan="1" rowspan="1"> File Name </td><td colspan="1" rowspan="1"> Enter the name of the file you want to import from Dropbox into Domo. </td></tr></tbody></table>
...
<Accordion title="What's the difference between this connector and the advanced version?">
