...
* If you choose **Enterprise OAuth**, enter the **client ID** and **client secret** associated with your SurveyMonkey app, and then select the domain to use for API calls. In most cases, select **US**. If you are in Canada, select **Canada**. If you are in Europe, select **Europe**. <Note>**Note:** When using Enterprise OAuth authentication, set the redirect URI to: [https://oauth.domo.com/api/data/v1/oauth/providers/surveymonkey-enterprise/exchange](https://oauth.domo.com/api/data/v1/oauth/providers/surveymonkey-enterprise/exchange). </Note>
