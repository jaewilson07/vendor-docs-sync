...
<Update label="v4.0.10" description="2026-09-25">

**[v4.0.10: Inside Job](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.10)**
...
### Fixes 🐞
* fix(stdio): tolerate a transport whose construction failed in `__del__` by [@kbkb628](https://github.com/kbkb628) in [#5256](https://github.com/PrefectHQ/fastmcp/pull/5256)
* tasks: register task tools hidden by search and CodeMode by [@zzstoatzz](https://github.com/zzstoatzz) in [#5262](https://github.com/PrefectHQ/fastmcp/pull/5262)
* tasks: run tools called from another tool in the foreground by [@zzstoatzz](https://github.com/zzstoatzz) in [#5275](https://github.com/PrefectHQ/fastmcp/pull/5275)
### Docs 📚
* Add Bluesky to docs footer by [@zzstoatzz](https://github.com/zzstoatzz) in [#5274](https://github.com/PrefectHQ/fastmcp/pull/5274)

## New Contributors
* @kbkb628 made their first contribution in [#5256](https://github.com/PrefectHQ/fastmcp/pull/5256)

**Full Changelog**: [v4.0.9...v4.0.10](https://github.com/PrefectHQ/fastmcp/compare/v4.0.9...v4.0.10)

</Update>

<Update label="v4.0.9" description="2026-09-24">

**[v4.0.9: Cache and Release](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.9)**
...
### Fixes 🐞
* resources: keep each template's compiled pattern on the template by [@zzstoatzz](https://github.com/zzstoatzz) in [#5253](https://github.com/PrefectHQ/fastmcp/pull/5253)


**Full Changelog**: [v4.0.8...v4.0.9](https://github.com/PrefectHQ/fastmcp/compare/v4.0.8...v4.0.9)

</Update>

<Update label="v4.0.8" description="2026-09-23">

**[v4.0.8: Take Three](https://github.com/PrefectHQ/fastmcp/releases/tag/v4.0.8)**
...
### Security 🔒
* completions: revert the list-based visibility check (#5240, #5244) by [@zzstoatzz](https://github.com/zzstoatzz) in [#5250](https://github.com/PrefectHQ/fastmcp/pull/5250)
### Fixes 🐞
* Fix OAuthProxy upstream refresh token revocation by [@Ujemny](https://github.com/Ujemny) in [#5243](https://github.com/PrefectHQ/fastmcp/pull/5243)
* resources: keep every compiled template pattern cached by [@zzstoatzz](https://github.com/zzstoatzz) in [#5248](https://github.com/PrefectHQ/fastmcp/pull/5248)

## New Contributors
* @Ujemny made their first contribution in [#5243](https://github.com/PrefectHQ/fastmcp/pull/5243)

**Full Changelog**: [v4.0.7...v4.0.8](https://github.com/PrefectHQ/fastmcp/compare/v4.0.7...v4.0.8)
